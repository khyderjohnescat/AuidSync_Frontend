...
function AnalyticsDashboard() {
  ...
  const handleFilterChange = (e) => {
    ...
    setFilters((prev) => ({
      ...prev,
      [name]: value === "" && name === "end_date" ? "" : value,
    }));
  };
  ...
  // Format chart data for the bar chart (Sales and Orders only)
  const barChartData = {
    ...
    <div className="bg-gray-800 min-h-screen p-6 text-white">
      <div className="max-w-7xl mx-auto bg-gray-900 p-6 rounded-lg shadow-md">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-center mb-8">
          <h2 className="text-3xl font-semibold text-white">Staff Dashboard</h2>
          <div className="flex gap-4 mt-4 sm:mt-0">
            ...
            >
              <FaArrowLeft className="mr-2 w-5 h-5" /> Back
            </button>
            <button
        ...
        <div className="bg-gray-800 p-6 rounded-lg shadow-md mb-8">
          <h3 className="text-xl font-medium text-white mb-4">Statistics</h3>
          {loadingChart ? (
                  ...
                  options={{
                    ...
                    scales: {
                      ...
                      y: {
                        ...
                        beginAtZero: true,
                        suggestedMax: Math.max(...chartData.map((entry) => parseFloat(entry.total_sales || 0))) * 1.1,
                      ...
                      "y-orders": {
                        ...
                        beginAtZero: true,
                        suggestedMax: Math.max(...chartData.map((entry) => entry.total_orders || 0)) * 1.1,
            ...
            <div className="bg-gray-800 p-6 rounded-lg shadow-md text-center hover:bg-gray-700 cursor-pointer transition duration-200">
              ...
              {loadingOverview ? (
                ...
                <p className="text-2xl font-bold text-green-400">
                  ₱{parseFloat(overviewData.total_sales || 0).toLocaleString("en-US", { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
                </p>
              )}
            </div>
          </Link>
            ...
            <div className="bg-gray-800 p-6 rounded-lg shadow-md text-center hover:bg-gray-700 cursor-pointer transition duration-200">
              ...
              {loadingOverview ? (
                ...
                <p className="text-2xl font-bold text-yellow-400">
                  {(overviewData.total_orders || 0).toLocaleString("en-US")}
                </p>
              )}
            </div>
          </Link>
